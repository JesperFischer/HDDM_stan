...
ss = gamlss::gamlss(mean ~ fitted*real*real_delta+Trial_number,
...
plot(ggeffects::ggpredict(ss, terms = c("real","fitted","real_delta")))+
...
gamlss::predictAll(ss, newdata = data.frame(fitted = "DDM", Trial_number = 50,real_delta = 1, real = 0.3, real_alpha = 1))
gamlss::predictAll(ss, newdata = data.frame(fitted = "RW", Trial_number = 50,real_delta = 1, real = 0.3, real_alpha = 1))
